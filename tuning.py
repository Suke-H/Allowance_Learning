...
from online import online, online_MNIST
from model import SimpleNet2, MNISTNet
...
def tuning():
    ...
    mu_list = [1, 3/4]
    out_path = "data/result/tuning/mnist/play/"
...
def tuningMNIST():
    ...
    # Model = SimpleNet2().to(device)
    Model = MNISTNet().to(device)
    out_path = "data/result/tuning/mnist/play/0.8_2/"
